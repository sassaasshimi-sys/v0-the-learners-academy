                    ...
                    >
                       ...
                       <div className="flex items-start justify-between">
                          <div className="space-y-1 font-sans">
                             ...
                             <p className="font-sans text-[9px] text-muted-foreground/40 uppercase tracking-widest">ID // {teacher.employeeId}</p>
                          </div>
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-64 p-4 rounded-[2rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] border-primary/10 backdrop-blur-3xl bg-card/90">
        <div className="px-3 py-2 border-b border-primary/5 mb-4 font-sans">
