      ...
      <Card className="border-primary/5 shadow-sm overflow-hidden bg-card/60 backdrop-blur-xl min-h-[600px]">
         ...
         <CardContent className="p-0">
            {loading ? (
              ...
              <div className="py-40 flex flex-col items-center justify-center space-y-4 font-sans">
                 ...
                 <div className="text-center space-y-1">
                    <p className="font-serif text-lg font-bold opacity-30 italic">No Billing Records Found</p>
                           ...
                           <td className="px-8 py-6">
                              <div className="flex items-center gap-4 font-sans">
                                 ...
                                 <div className="space-y-0.5">
                                    <p className="font-serif font-bold text-base text-foreground/80 leading-tight">{p.student.name}</p>
                                    <p className="text-[10px] font-bold text-muted-foreground/30 uppercase tracking-widest">{p.student.studentId || 'No ID'}</p>
                                 </div>
                              </div>
                           </td>
          ...
          <div className="space-y-6 pt-4">
             <div className="p-5 rounded-2xl bg-primary/5 border border-primary/5 space-y-3">
                ...
                <div className="flex justify-between items-center text-[11px] font-bold">
                   <span className="font-sans opacity-40 uppercase tracking-widest leading-none">Already Collected</span>
                   <span className="font-serif text-success leading-none">Rs. {(selectedPayment as any)?.amountPaid?.toLocaleString()}</span>
                </div>
             </div>
