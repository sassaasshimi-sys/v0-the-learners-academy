      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         <Card className="lg:col-span-2 overflow-hidden border-primary/5 shadow-sm bg-card/60 backdrop-blur-xl flex flex-col h-full">
            <CardHeader className="flex flex-row items-center justify-between pb-2 border-b border-primary/5 px-8 py-6">
               ...
               <div className="text-right">
                  <p className="font-sans text-[10px] font-black uppercase tracking-widest opacity-30 leading-none">Total Outflow</p>
         ...
         <Card className="border-primary/5 bg-primary shadow-[0_40px_100px_-30px_rgba(var(--primary),0.35)] text-primary-foreground relative overflow-hidden group h-full">
            ...
            <CardContent className="px-8 pb-8 mt-4 space-y-6">
               ...
               <div className="pt-2">
                  <p className="font-sans text-[10px] uppercase font-black tracking-widest opacity-40 mb-1 leading-none">Outstanding Receivables</p>
                 ...
                 <Card className="hover-lift transition-premium border-primary/5 shadow-sm group h-full flex flex-col">
                    <CardContent className="p-6 flex flex-col flex-1">
                       <div className="flex items-center justify-between mb-6">
                          ...
                          <Badge variant="ghost" className="font-sans text-[9px] font-black uppercase tracking_widest opacity-20 px-2 py-0.5">Audit V1</Badge>
                       </div>
         ...
         <CardContent className="p-0">
            {stats.transactions?.length === 0 ? (
               <div className="py-24 flex flex-col items-center justify-center text-center space-y-4 font-sans">
                  ...
                  <p className="text-[9px] uppercase tracking-[0.2em] font-black opacity-10 italic">Historical data synchronized // Registry empty</p>
               </div>
            ) : (
          ...
          <div className="space-y-5 font-sans">
             <div className="space-y-2">
                ...
                <Select value={newExp.category} onValueChange={(v) => setNewExp({...newExp, category: v})}>
                   <SelectTrigger className="h-12 rounded-xl border-primary/10 bg-white/50 text-xs font-bold font-sans">
             ...
             <div className="space-y-2">
                ...
                <Input 
                   ...
                   className="h-12 rounded-xl border-primary/10 bg-white/50 text-xs font-medium font-sans"
                />
             </div>
             <div className="flex flex-col gap-3 pt-6 font-sans">
